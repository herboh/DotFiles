...
/*	{ MODKEY,			XK_backslash,		view,		{0} },
	...
	{ MODKEY,			XK_s,		spawn,          SHCMD(TERMINAL " -e spt") },
	{ MODKEY|ShiftMask,	XK_s,		spawn,			SHCMD("killall spotify; -e spotifyd") },
	...
	{ MODKEY|ShiftMask,	XK_Return,		spawn,		SHCMD(TERMINAL " -e nvim") },
	...
	{ 0,				XK_Print,	spawn,		SHCMD("-e scrot pic-full-$(date '+%y%m%d-%H%M-%S').png") },
	{ ShiftMask,		XK_Print,	spawn,		SHCMD("-e scrot -s") },
	...
	{ 0, XF86XK_AudioMedia,		spawn,		SHCMD(TERMINAL " -e spt") },
